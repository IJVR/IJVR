...
namespace Proxies\__CG__\IJVR\PublishBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Article extends \IJVR\PublishBundle\Entity\Article implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'IJVR\\PublishBundle\\Entity\\Article' . "\0" . 'issue', '' . "\0" . 'IJVR\\PublishBundle\\Entity\\Article' . "\0" . 'id', '' . "\0" . 'IJVR\\PublishBundle\\Entity\\Article' . "\0" . 'title', '' . "\0" . 'IJVR\\PublishBundle\\Entity\\Article' . "\0" . 'abstract', '' . "\0" . 'IJVR\\PublishBundle\\Entity\\Article' . "\0" . 'authors', '' . "\0" . 'IJVR\\PublishBundle\\Entity\\Article' . "\0" . 'date', '' . "\0" . 'IJVR\\PublishBundle\\Entity\\Article' . "\0" . 'pdf');
        }
