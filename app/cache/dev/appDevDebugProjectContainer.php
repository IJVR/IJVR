...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'ijvrorg_symfony', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\IJVR\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\IJVR\\PublishBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'IJVR\\UserBundle\\Entity');
        $c->addDriver($b, 'IJVR\\PublishBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('IJVRUserBundle' => 'IJVR\\UserBundle\\Entity', 'IJVRPublishBundle' => 'IJVR\\PublishBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_172db961c50fb1607d832f99fd407487c70fbc4621efcbf3282f69741c4ea881');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('IJVR\\UserBundle\\Entity\\User\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('IJVR\\UserBundle\\Entity\\User\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('IJVR\\UserBundle\\Entity\\User\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('IJVR\\UserBundle\\Entity\\User\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'IJVR\\UserBundle\\Entity\\User\\User');
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('IJVR\\UserBundle\\Entity\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $l = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), '0d35b8b4656e153b0a8697b12a5d97f7e01e4a65', 'main', array('name' => 'REMEMBERME', 'lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);

        $m = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $k, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($k, '/platform/home'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'fos_user_security_logout'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\IJVR\\PlatformBundle/Resources/views'), 'IJVRPlatform');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\IJVR\\UserBundle/Resources/views'), 'IJVRUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\IJVR\\PublishBundle/Resources/views'), 'IJVRPublish');
        $instance->addPath(($this->targetDirs[3].'\\src\\IJVR\\SearchBundle/Resources/views'), 'IJVRSearch');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('0d35b8b4656e153b0a8697b12a5d97f7e01e4a65');
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('fos_user.user_provider.username'), $a, 'main', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($a, '0d35b8b4656e153b0a8697b12a5d97f7e01e4a65', 'main'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5639d540219122.64002856')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'IJVRPlatformBundle' => 'IJVR\\PlatformBundle\\IJVRPlatformBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'IJVRUserBundle' => 'IJVR\\UserBundle\\IJVRUserBundle',
                'IJVRPublishBundle' => 'IJVR\\PublishBundle\\IJVRPublishBundle',
                'IJVRSearchBundle' => 'IJVR\\SearchBundle\\IJVRSearchBundle',
            ...
            'secret' => '0d35b8b4656e153b0a8697b12a5d97f7e01e4a65',
            'locale' => 'en',
            ...
            'kernel.secret' => '0d35b8b4656e153b0a8697b12a5d97f7e01e4a65',
            ...
            'fos_user.model.user.class' => 'IJVR\\UserBundle\\Entity\\User\\User',
