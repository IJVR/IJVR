...
class Article
{
   ...
   */
     ...
     * @var string
     *
     * @ORM\Column(name="authors_text", type="text")
     */
    private $authors_text;
	...
	*/
     ...
     * @return Article
     */
    public function setAuthorsText($authorsText)
    {
        $this->authors_text = $authorsText;
